					...
					<div class="span9">					
						...
						<table class="table table-striped">
							...
							<tbody>
								@foreach($c as $c)
								<tr>
									<td><a href="{{route('cart.delete', [$c->cart_id])}}"><input type="button" value="Remove"></a></td>
									<td><a href="product_detail.html"><img alt="" src="{{ asset($c->picture) }}" style="width: 50px; height: 50px;"></a></td>
									<td>{{$c->pro_name}}</td>
									<td>{{$c->quantity}}</td>
									<td>{{$c->price}}</td>
									<td>{{$c->total_price}}</td>
